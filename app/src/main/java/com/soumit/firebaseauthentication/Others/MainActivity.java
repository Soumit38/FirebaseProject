...
import com.soumit.firebaseauthentication.Auth.SignupActivity;
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(MainActivity.this, "Email address updated, " +
                                                "Please Sign in with new email id!", Toast.LENGTH_SHORT).show();
                                        signOut();
                                        progressBar.setVisibility(view.GONE);
                                    }else {
                ...
                if(user != null && !newPassword.getText().toString().trim().equals("")){
                    ...
                    user.updatePassword(newPassword.getText().toString().trim())
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(MainActivity.this, "Password is updated, " +
                                                "sign in with new password", Toast.LENGTH_SHORT).show();
                                        signOut();
                                        progressBar.setVisibility(View.GONE);
                                    }else {
                ...
                if(!oldEmail.getText().toString().trim().equals("")){
                    auth.sendPasswordResetEmail(oldEmail.getText().toString().trim())
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(MainActivity.this, "Reset password email is sent!",
                                                Toast.LENGTH_SHORT).show();
                                        progressBar.setVisibility(View.GONE);
                                    }else {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(MainActivity.this, "Your profile is deleted :( " +
                                                "Create an account now!", Toast.LENGTH_SHORT).show();
